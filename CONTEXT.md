...
Run tests: `for t in test_foundation test_agent test_evalproto test_subagents test_orchestrator test_cli test_library test_tui test_backends test_seeds test_ledger test_research; do PYTHONPATH=src .venv/bin/python -m tests.$t; done` (74 checks, all offline except one live GitHub fetch)
